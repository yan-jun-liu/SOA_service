...
type SendspaceToken struct {
	Result string `xml:"result"`
	Token  string `xml:"token"`
}

type MediafireToken struct {
...
func login(rw http.ResponseWriter, req *http.Request) {
	...
	var sendspace_token SendspaceToken
	...
	var mediafire_token MediafireToken
...
func getSendspaceToken() (SendspaceToken, error) {
	...
	log.Println(string(body))
	var token SendspaceToken
	err = xml.Unmarshal(body, &token)
	return token, err
}

func getMediafireToken(user User) (MediafireToken, error) {
